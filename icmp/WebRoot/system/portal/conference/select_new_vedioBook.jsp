			          ...
			          int deptLength = listDpt.size();
					      for(int i=0;i<deptLength;i++){
					        ...
					        // UserAction  userAction = new UserAction();
					         ...
					         ArrayList lst_user = dptAction.getHaveTerminalMeetingRoomByAddress(departID, sessionUvo);
...
<div class="boxbg" align="left"  style="border:1px solid #437e8c;">
 ...
 <div class="min-widthdiv contentwrapper">
	<div id="basicform" style="border:1px solid #ccc">
      	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        	<tr>
          		<td height="55">搜索 : <input id="searchMeeingRoom1" class="glass" onkeypress="EnterPress(event)" onkeyup="reStore();" /><img src="/icmp/images/icons/glass.png"/ onclick="serachRoom();" style="cursor:pointer;" title="搜索"></td>
