	...
	$.extend({
		progressBar: new function() {
			this.defaults = {
				...
				boxImage		: '/icmp/meeting/meetingManage/comparison/images/progressbar.gif',// boxImage : 包着进度条的图片
				barImage		: {
									0:	'/icmp/meeting/meetingManage/comparison/images/progressbg_green.gif',
									30: '/icmp/meeting/meetingManage/comparison/images/progressbg_green.gif',
									50: '/icmp/meeting/meetingManage/comparison/images/progressbg_green.gif',
									70: '/icmp/meeting/meetingManage/comparison/images/progressbg_green.gif',
									90: '/icmp/meeting/meetingManage/comparison/images/progressbg_green.gif',
