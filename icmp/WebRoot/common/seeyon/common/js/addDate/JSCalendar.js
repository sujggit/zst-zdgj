...
//		+ "<img src='" + _imgReset1.src + "' onmouseover=this.src='" + _imgReset2.src + "' onmouseout=this.src='" + _imgReset1.src + "'></td>"
		...
		+ "<td width=30px class='ok' onclick='parent.ok()'>OK</td>"
		+ "<td width=30px class='ok' onclick='parent.ok1()'>Reset&nbsp;&nbsp;</td>"
...
function fillCldTabFrm(year, month, date){
	...
	_cldTabFrm.rows(0).cells(0).innerHTML
	 = "<table  class=calendar style=\"font-weight:bolder;border:0px;border-bottom:1px solid #85B4E1;width:100%;height:24px;\" cellspacing=0 cellpadding=0>"
		...
		+ " <input type='text' maxlength='4' class='year-input' onfocus='this.select()' onkeyup='parent.inputYear1(this)' onchange='parent.inputYear(this);' value='" + _dCurYear + "'>"
