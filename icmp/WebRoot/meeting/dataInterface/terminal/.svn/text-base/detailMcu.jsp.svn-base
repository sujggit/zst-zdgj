    ...
    <div class="contenttitle2" style="width:100%">
        ...
        <tr>
          ...
          <td width="30%" class="tableadd_data">
               <zzst:lable type="equipment_Mcu_Model" value="${difVO.equipmentModel}"></zzst:lable>         
            </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="tableaddtitle">所属会议室编号</td>
        ...
        <tr>
          ...
          <td class="tableadd_data"><c:out value="${difVO.commandIP}"></c:out></td>
        </tr>
        <tr>
