...
<form action="${sys_ctx}/address/addAddress.action" id="addressForm" name="addressForm" method="post">
<div id="container">
<div class="content">
<div class="tablesdiv">
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tables" align="center">
          <tr>
		    ...
		    <input type="text" name="addressVO.name" id="addressVO.name" class="input200 fontstyle" value=""/>  
            </td>
          </tr>
          <tr>
            <td class="ar fontstyle fontb pr3 tdhight"><span class="fonttsx">*</span>上级节点：</td>
            <td class="al pl3"> <input type="text" name="addressVO.parentID" id="addressVO.parentID" class="input200 fontstyle" value="" />
            </td>
          </tr>
          <tr>
            <td class="ar fontstyle fontb pr3 tdhight"><span class="fonttsx">*</span>状态：</td>
           <td class="al pl3">
            <input type="text" name="addressVO.status" id="addressVO.status" class="input200 fontstyle" value="" />
            </td>
          </tr>
          <tr>
		   <td class="ar fontstyle fontb pr3 tdhight"><span class="fonttsx">*</span>描述：</td>
           <td class="al pl3">
           		<input type="text" name="addressVO.description" id="addressVO.description" class="input200 fontstyle" value=""/>
           </td> 
          </tr>
        </table>
          </div>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="buttoncontainer">
  <tr>
    <td><input type="button" name="button" id="button" value="确 定" onclick="addressAdd();"  class="submit1 radius2 submitBtn_Disa" />
