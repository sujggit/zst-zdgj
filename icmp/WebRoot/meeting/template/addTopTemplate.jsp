	...
	<script language="JavaScript">
			...
			*/
            function backHistory(){
            	window.location.href="${sys_ctx}/detail/manageTopMeetingTemplateList.action";
            };
...
<form action="${sys_ctx}/detail/addTopTemplate.action" id="addForm" name="addForm" method="post">
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
        <tr>
          ...
          <input class="inputtran" style="width:80%" type="text" name="templateVO.templateName" id="templateName"/>
          </td>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="buttoncontainer" id="table">
        ...
        <tbody>
          <tr>
            <td>
              <input type="button" class="submit1 radius2 submitBtn_Disa" value="确 定" onclick="templateAdd();"/>
