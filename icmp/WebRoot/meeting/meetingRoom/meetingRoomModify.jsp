		...
		*/
		...
		//校验会议室名字是否存在，不包括自己本身
         ...
         $("#button").attr("disabled",true);
    		  ...
    		  if(a.value==""||a.value==null||"${meetingRoomVO.meetingRoomName }" == a.value){
     	...
     	function checkNO(op){
			    $("#button").attr("disabled",true);
			  if(op.value==""||op.value==null || "${meetingRoomVO.roomNO}" == op.value){
			   $("#button").attr("disabled","");
				return;
			  }
...
<body onload="pageInit();" style='OVERFLOW:AUTO;OVERFLOW-X:HIDDEN'>
  ...
  <form action="${sys_ctx}/meetingRoom/modifySave.action" id="modifyForm" name="modifyForm" method="post">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
        <tr>
          ...
          <td width="35%" class="tableadd_data" >
            <input class="inputtran" style="width:80%" type="text" name="meetingRoomVO.meetingRoomName" id="meetingRoomName" value='<c:out value="${meetingRoomVO.meetingRoomName }"></c:out>' onblur="javascript:check('meetingRoomName');"/>
          </td>
        ...
        <tr>
          ...
          <td class="tableadd_data" >
                 <select class="" name="meetingRoomVO.status" id="status" >
        ...
        <tr>
          ...
          <td class="tableadd_data"><input class="inputtran" type="text" name="meetingRoomVO.roomNO" id="roomNO"  value="${meetingRoomVO.roomNO}" onblur="checkNO(this)"/></td>
        </tr>
        <tr>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="buttoncontainer" id="table">
        ...
        <tbody>
          <tr>
            <td>
              <input type="button" class="submit1 radius2" value="确 定" onclick="MeetingRoomModify();" id="button"/>
