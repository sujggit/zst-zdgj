...
<body onload="pageInit();" style='OVERFLOW:AUTO;OVERFLOW-X:HIDDEN'>
  <form action="${sys_ctx}/equipment/noticeAdd.action" id="addNoticeForm" name="addNoticeForm" method="post"/>
	<div id="basicform" class="contentwrapper">
       <div id="m" style="background:none;border:none">    
         <%@include file="/meeting/equipment/equipmentAddHead.jsp"%>
       </div> 
       <div id="k6"  class="k" style="display:block"/> 
          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
              <tr>
                ...
                <td width="35%" class="tableadd_data" >
                 <select name="equipmentVO.equipmentType" id="equipmentType" class="inputtran" disabled="disabled">
						<zzst:option type="equipmentEnum" value="4" required="true"/>
			   		  </select>    
                </td>
            ...
            <!--     <td class="tableaddtitle"><span>*</span>设备型号</td>
                ...
                <td class="tableadd_data">
                	<input type="text" name="equipmentVO.mac" id="mac" class="inputtran" value="" />
                </td>
              </tr>
              <tr>
              ...
              <tr>
               <td class="tableaddtitle"><span>*</span>所属会议室</td>
                ...
                <td class="tableadd_data" >
                <input id="port" name="equipmentVO.port" value="" type="text" class="inputtran" />
                </td>
                 -->
              </tr>
              <tr>
  	 ...
  	 <tr>
        ...
        <td class="tableadd_data" >
          <input name="equipmentVO.createDate" class="inputtran" id="createDate" type="text" style="cursor:pointer" readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'});" value="<%=simpledateformat.format(date)%> "/>
   		</td>
             </tr>
              <tr>
