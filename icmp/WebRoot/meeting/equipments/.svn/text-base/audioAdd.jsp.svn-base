...
function equipmentAdd(){
  ...
  <form action="${sys_ctx}/equipment/audioAdd.action" id="addMcuForm" name="addMcuForm" method="post"/>
                    ...
                    <tr>
                      ...
                      <td width="35%" class="tableadd_data" >
	                      <select name="equipmentVO.equipmentType" id="equipmentType" class="inputtran" disabled="disabled">
							<zzst:option type="equipmentEnum" value="9" required="true"/>
			   			  </select>
	                      <input type="hidden" name="equipmentVO.equipmentType" id="equipmentType" class="inputtran"  value="9"/>
                      </td>
