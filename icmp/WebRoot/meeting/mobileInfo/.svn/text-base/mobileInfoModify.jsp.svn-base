...
<body onload="pageInit();">
  <div id="basicform" class="contentwrapper">
    <form action="${sys_ctx }/mobileInfo/modifyMobileInfo.action" 	method="post" name="form" id="form">
      <div class="contenttitle2">
        <h5 class="fwb fl10">联系人增加</h5>
      </div>
      <input type="hidden" value="${mobileInfoVO.id }" name="mobileInfoVO.id"/>
      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd" id="query_tableOther">
        <tr>
          ...
          <td width="35%" class="tableadd_data" ><input id="myname" class="inputtran" name="mobileInfoVO.name" value="${mobileInfoVO.name }"/></td>
        </tr>
        <tr>
          <td class="tableaddtitle"><span>*</span>电话</td>
          <td class="tableadd_data" ><input id="mymobile" class="inputtran" name="mobileInfoVO.mobile" value="${mobileInfoVO.mobile }"/></td>
        </tr>
      </table>
