...
<html>
  ...
  <body onload="venueSortable()">
    ...
    <div id="screenContainer" class="participantsContainerDiv" style="">
     <div id="participantsContainer3" style="width:98%;height:40%;position:absolute;left:0px;top:48%" class="participants">
     <c:out value="${defaultVenue1}"></c:out>
	    <ul id="terList3">
		   	<c:forEach items="${tList1}" var="ter3" varStatus="s">
		   		<li id="ter3${s.count }">
      ...
      <c:out value="${defaultVenue2}"></c:out>
	    <ul id="terList1">
		   	<c:forEach items="${tList2}" var="ter1" varStatus="k">
			   	<li id="ter1${k.count }">
     ...
     <c:out value="${defaultVenue3}"></c:out>
	    <ul id="terList2">
		   	<c:forEach items="${tList3}" var="ter2" varStatus="s">
		   		<li id="ter2${s.count }">
