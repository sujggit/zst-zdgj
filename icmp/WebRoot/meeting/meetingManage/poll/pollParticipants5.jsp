...
<html>
  ...
  <body onload="venueSortable()">
    ...
    <div id="screenContainer" class="participantsContainerDiv">
      <div id="participantsContainer1" style="width:66%;height:66%;" class="participants">
     ...
     <div id="participantsContainer3" style="width:33%;height:33%;" class="participants">
	    ...
	    <ul id="terList3">
		   	<c:forEach items="${tList3}" var="ter3" varStatus="s">
		   		<li id="ter3${s.count }">
			   		...
			   		<input type="button" class="participantsDelBtn" value="删除" onclick="delTerminal('ter3${s.count}')"/>
			   		<span class="participantsSpan">${ter3.mcu_participant_name }</span>
		   		</li>
	   		</c:forEach>
	   	</ul>
     </div>
     <div id="participantsContainer4" style="width:33%;height:34%;" class="participants">
	    ...
	    <ul id="terList4">
		   	<c:forEach items="${tList4}" var="ter4" varStatus="s">
		   		<li id="ter4${s.count }">
			   		...
			   		<input type="button" class="participantsDelBtn" value="删除" onclick="delTerminal('ter4${s.count}')"/>
			   		<span class="participantsSpan">${ter4.mcu_participant_name }</span>
		   		</li>
	   		</c:forEach>
	   	</ul>
     </div>
     <div id="participantsContainer5" style="width:33%;height:34%;" class="participants">
	    ...
	    <ul id="terList5">
		   	<c:forEach items="${tList5}" var="ter5" varStatus="s">
		   		<li id="ter5${s.count }">
			   		...
			   		<input type="button" class="participantsDelBtn" value="删除" onclick="delTerminal('ter5${s.count}')"/>
					<span class="participantsSpan">${ter5.mcu_participant_name }</span>
		   		</li>
	   		</c:forEach>
	   	</ul>
     </div>
     <div id="participantsContainer6" style="width:32%;height:34%;" class="participants">
	    ...
	    <ul id="terList6">
		   	<c:forEach items="${tList6}" var="ter6" varStatus="s">
		   		<li id="ter6${s.count }">
			   		...
			   		<input type="button" class="participantsDelBtn" value="删除" onclick="delTerminal('ter6${s.count}')"/>
