...
<html>
  ...
  <body onload="init()">
    ...
    <div id="screenContainer" class="screenContainerDiv">
      <div id="screen1" style="width:66%;height:66%;" class="screen">
     ...
     <div id="screen2" style="width:33%;height:33%;" class="screen">
       <ul id="confList2" class="screenUl">
   	   </ul>
     </div>
     <div id="screen3" style="width:33%;height:33%;" class="screen">
       <ul id="confList3" class="screenUl">
   	   </ul>
     </div>
     <div id="screen4" style="width:33%;height:34%;" class="screen">
       <ul id="confList4" class="screenUl">
   	   </ul>
     </div>
     <div id="screen5" style="width:33%;height:34%;" class="screen">
       <ul id="confList5" class="screenUl">
   	   </ul>
     </div>
     <div id="screen6" style="width:32%;height:34%;" class="screen">
