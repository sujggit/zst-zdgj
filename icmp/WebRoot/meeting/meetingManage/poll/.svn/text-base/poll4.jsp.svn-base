...
<html>
  ...
  <body onload="init()">
    ...
    <div id="screenContainer" class="screenContainerDiv">
      <div id="screen1" style="width:50%;height:50%;" class="screen">
     ...
     <div id="screen2" style="width:49%;height:50%;" class="screen">
       <ul id="confList2" class="screenUl">
   	   </ul>
     </div>
     <div id="screen3" style="width:50%;height:50%;" class="screen">
       <ul id="confList3" class="screenUl">
   	   </ul>
     </div>
     <div id="screen4" style="width:49%;height:50%;" class="screen">
