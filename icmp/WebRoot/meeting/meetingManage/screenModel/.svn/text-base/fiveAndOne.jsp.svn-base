...
<%--			var mcuType = parent.document.getElementById(confID).value;--%>
			...
			var selectItem6 = document.getElementById('selectId6');
	 		var selectItems = selectItem1.value + "_" + selectItem2.value + "_" + selectItem3.value + "_" + selectItem4.value+ "_" + selectItem5.value+ "_" + selectItem6.value;
			...
			if(selectItems != null){
				...
				McuDwrMethod.setVideoScreen(meetingDetailID, confID, lecturer, videoMode, '${LAYOUT_MODE}', 6, selectItems);
...
<body>
   ...
   <table width="100%" border="0" cellspacing="1" cellpadding="0" height="100%" bgcolor="#e4eafa">
   	 ...
   	 <td colspan="3" bgcolor="#bdcbef" style="border:1px solid #505050;height:30px;font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;分屏模式： 
   	   ...
   	   -->
   	   <tr>
   	     <td width="66%" rowspan="2" colspan="2" style="border:1px solid #505050" valign="top"><form id="form1" name="form1" method="post" action="" class="selectform" style="text-align:center">
