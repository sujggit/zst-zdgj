    ...
    <script type='text/javascript'>
    	function setVideo3(videoModeId, lecturerId){
			...
			var selectItem4 = document.getElementById('selectId4');
	 		...
	 		var selectItems = selectItem1.value + "_" + selectItem2.value + "_" + selectItem3.value + "_" + selectItem4.value;
			...
			if(selectItems != null){
				...
				McuDwrMethod.setVideoScreen(meetingDetailID, confID, lecturer, videoMode, '${LAYOUT_MODE}', 4, selectItems);
   ...
   <table width="100%" border="0" cellspacing="1" cellpadding="0" height="100%" bgcolor="#e4eafa">
   	 ...
   	 <td colspan="3" bgcolor="#bdcbef" style="border:1px solid #505050;height:30px;font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;分屏模式： 
   	   ...
   	   <tr>
 	       ...
 	       <td width="33%" rowspan="1" colspan="1" style="border:1px solid #505050" valign="top">
   	   ...
   	   <tr>
   	     <td width="33%" style="border:1px solid #505050">
   	     <form id="form1" name="form1" method="post" action="" class="selectform" style="text-align:center">
   	       <div style="margin-top:25px;">
 	       ...
 	       <td width="33%" style="border:1px solid #505050"><form id="form1" name="form1" method="post" action="" class="selectform" style="text-align:center">
   	       <div style="margin-top:25px;">
   	   ...
   	   <tr>
   	     <td height="63" colspan="2" style="border:1px solid #505050" align="center" bgcolor="#bdcbef">
