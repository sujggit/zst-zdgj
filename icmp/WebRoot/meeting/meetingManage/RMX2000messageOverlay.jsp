...
<%--	    <option value="large" ${confVO.fontSize=="large" ? "selected" : "" }>大</option>--%>
 ...
 <!-- <select name="confVO.color" id="colorID" style="width:150px;">
    	<option value="0x00FF0000_0x00FFFFFF" >白底红字</option>
	    <option value="0x00FFFFFF_0x00800000" >红底白字</option>
	    <option value="0x00FFFFFF_0x00000000">黑底白字</option>
	    <option value="0x00FFFF00_0x00000000">黑底黄字</option>
	   </select>
<!--    2000、4000颜色定义 -->
  <select name="confVO.color" id="colorID" style="width:150px;">
   	<option value="white_font_on_red_background"  ${confVO.color=="white_font_on_red_background" ? "selected" : "" } >红色</option>
	    <option value="white_font_on_light_blue_background" ${confVO.color=="white_font_on_light_blue_background" ? "selected" : "" }>白色</option>
	    <option value="white_font_on_black_background" ${confVO.color=="white_font_on_black_background" ? "selected" : "" }>黑色</option>
	    <option value="white_font_on_gray_background" ${confVO.color=="white_font_on_gray_background" ? "selected" : "" }>灰色</option>
	    <option value="white_font_on_orange_background" ${confVO.color=="white_font_on_orange_background" ? "selected" : "" }>橘红</option>
	    <option value="white_font_on_blue_background" ${confVO.color=="white_font_on_blue_background" ? "selected" : "" }>蓝色</option>
	    <option value="white_font_on_olive_background" ${confVO.color=="white_font_on_olive_background" ? "selected" : "" }>橄榄色</option>
	    <option value="white_font_on_green_background" ${confVO.color=="white_font_on_green_background" ? "selected" : "" }>绿色</option>
	    <option value="white_font_on_purple_background" ${confVO.color=="white_font_on_purple_background" ? "selected" : "" }>紫色</option>
  </select>
    </td>
  </tr>
  ...
  <tr>
   ...
   <tr id="position">
    ...
    <td   class="tableadd_data" >
    <input type="text" value="${confVO.align}" name="confVO.align" id="positionID"/><span style="color:red">*限1-100以内</span>
<!--    原来位置显示-->
...
<!--    </select>-->
  ...
  <script>
	...
	if(document.getElementById("isShow").value == "true"){
