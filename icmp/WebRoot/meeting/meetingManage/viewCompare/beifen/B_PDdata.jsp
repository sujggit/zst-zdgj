...
<chart bgColor="E9E9E9" labelStep="15" outCnvBaseFontColor="666666"
	caption="B" xAxisName="" yAxisName="Sales" numberPrefix=""
...
<dataset seriesName="B_reference" color="b1d1dc"	plotBorderColor="b1d1dc"> 

<%
                ComparisonReferenceVO crv=ServiceFactory.getConparisonReferenceService().queryByID("1");
			    String reference=crv.getB_Pb().trim();
...
<dataset seriesName="B_detail" color="0275c6"	plotBorderColor="0275c6"> 

<%
                ComparisonDetailVO detail=ServiceFactory.getConparisonDetailService().queryByID("1");
			    String detailRs=detail.getB_Pb().trim();
