...
<chart bgColor="E9E9E9" labelStep="15" outCnvBaseFontColor="666666"
	caption="G" xAxisName="" yAxisName="Sales" numberPrefix=""
...
<dataset seriesName="G_reference" color="b1d1dc"	plotBorderColor="b1d1dc"> 

<%
                ComparisonReferenceVO crv=ServiceFactory.getConparisonReferenceService().queryByID("1");
			    String reference=crv.getG_Y().trim();
...
<dataset seriesName="G_detail" color="00b450"	plotBorderColor="00b450"> 

<%
                ComparisonDetailVO detail=ServiceFactory.getConparisonDetailService().queryByID("1");
			    String detailRs=detail.getG_Y().trim();
