...
<div class="k_right">
	<div>
    	<ul style="width:119px;height:80px;float:left;margin-right:5px">
        	<li>
				<select id="2">
    ...
    <div>
    	<ul style="width:119px;height:80px;float:left">
        	<li>
				<select id="5">
					<c:forEach items="${meetingMcuVOList}" var="meetingMcu">
    ...
    <div>
    	<ul style="width:265px;height:102px;float:left;margin-right:5px;margin-top:5px">
        	<li>
				<select id="0">
					<c:forEach items="${meetingMcuVOList}" var="meetingMcu">
        ...
        <ul style="width:265px;height:102px;float:left;margin-top:5px">
        	<li>
				<select id="1">
					<c:forEach items="${meetingMcuVOList}" var="meetingMcu">
    ...
    <div>
    	<ul style="width:119px;height:80px;float:left;margin-right:5px;margin-top:5px">
        	<li>
				<select id="6">
					<c:forEach items="${meetingMcuVOList}" var="meetingMcu">
    ...
    <div>
    	<ul style="width:119px;height:80px;float:left;margin-top:5px">
        	<li>
				<select id="9">
					<c:forEach items="${meetingMcuVOList}" var="meetingMcu">
...
<table cellpadding="0" cellspacing="0" border="0" class="buttoncontainer k_bottom" id="table">
    ...
    <tbody>
		<tr>
			<td id="frmright1"><input name="提交" type="button" class="submit1 radius2" value="生效"  onclick="splitSubmit(10,'${LAYOUT_MODE}')"/></td>
		</tr>
	</tbody>
</table>
</body>
