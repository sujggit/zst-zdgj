 ...
 *****************************************************************/
	...
	JS_BRAMUS.jsProgressBarHandler.prototype = {
		...
		buildProgressBar	: function(progressBar) {
			...
			progressBar.update('<img id="' + id + '_percentImage" src="/icmp/meeting/meetingManage/comparison/images/percentImage.png" alt="0%" style="background-position: 0px 0px;"/> <span id="' + id + '_percentText">0%</span>');
