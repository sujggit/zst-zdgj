...
<script type='text/javascript' src='${sys_ctx }/meeting/equipment/check.js'> </script>
		<script type="text/javascript">
          ...
          function checkRoomIsOnly(equipmentType){
  			...
  			var meetingRoomName = document.getElementById("meetingRoomName").value;
  			if(meetingRoomID && "${equipmentVO.meetingRoomVO.meetingRoomName}"!=meetingRoomName){
...
<form action="${sys_ctx}/equipment/controlModify.action" id="modifyForm" name="modifyForm" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tables" align="center">
          <tr>
           ...
           <td width="30%" class="al pl3">
			 <c:if test="${equipmentVO.equipmentType==0}">
				        <input type="text" name="equipmentVO.equipmentType" id="equipmentType" class="input200 fontstyle" value="终端" disabled />                       
              </c:if>
              <c:if test="${equipmentVO.equipmentType==1}">
                    <input type="text" name="equipmentVO.equipmentType" id="equipmentType" class="input200 fontstyle" value="MCU"  disabled />                                                                                  
			  </c:if> 
			   <c:if test="${equipmentVO.equipmentType==2}">
                    <input type="text" name="equipmentVO.equipmentType" id="equipmentType" class="input200 fontstyle" value="中控"  disabled />                                                                                  
			  </c:if> 
          ...
          <tr>
            ...
            <td class="al pl3">
             <input type="text" name="equipmentVO.ip" id="ip" class="input200 fontstyle" value="${equipmentVO.ip}"  />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tables">
  <tr>
    <td class="btntable ac"><input type="button" name="button" id="button" value="确 定" onclick="mcuModify();"  class="button fontstyle fontb" />
 ...
 <div class="contenttitle2">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
        ...
        <tr>
          ...
          <td class="tableadd_data" > <input type="text" maxlength="25" name="equipmentVO.ip" id="ip" class="inputtran" value="${equipmentVO.ip}" onchange="check('ip');" /></td>
        ...
        <tr>
          ...
          <td class="tableadd_data" ><input type="hidden" name="equipmentVO.meetingRoomVO.meetingRoomID" id="meetingRoomID" class="" value="${equipmentVO.meetingRoomVO.meetingRoomID}"  />
                             <input type="text" name="equipmentVO.meetingRoomVO.meetingRoomName" id="meetingRoomName" class="inputtran" style="cursor:pointer" readonly="readonly"  value="${equipmentVO.meetingRoomVO.meetingRoomName}" onclick="selectConference(this)" onblur="checkRoomIsOnly(<%=EquipmentEnum.TYPE_ID_CENTERCONTROL %>)"/></td>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="buttoncontainer" id="table">
        ...
        <tbody>
          <tr>
            ...
            <input type="button" name="button" id="button" class="submit1 radius2" value="确 定" onclick="mcuModify();"/>
