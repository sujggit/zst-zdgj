 	  ...
 	  <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
        ...
        <tr>
          ...
          <td class="tableadd_data">${equipmentVO.serialNumber}</td>
           ...
           <!--  <td class="tableadd_data" colspan="3"> <textarea readonly style="height: auto;width:86%" rows="13" ><c:out value="${equipmentVO.description}"></c:out></textarea></td>
           -->
            <td class="tableadd_data" colspan="3"><c:out value="${equipmentVO.description}"></c:out></td>
           </tr>
        </table>
