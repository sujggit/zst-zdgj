...
<form action="${sys_ctx}/equipment/mcuModify.action" id="modifyForm" name="modifyForm" method="post">
<input type="hidden" name="equipmentVO.equipmentID" id="equipmentID" class="" value="${equipmentVO.equipmentID}"  />
<input type="hidden" name="equipmentMcuVO.equipmentID" id="equipmentIDs" class="" value="${equipmentMcuVO.equipmentID}"  />
 <div id="basicform" class="contentwrapper"> 
  <div class="contenttitle2">
        <h5 class="fwb fl10">MCU修改</h5>
      </div>
      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
        ...
        <tr>
          ...
          <td class="tableadd_data"><input type="text" maxlength="25" name="equipmentVO.equipmentNO" id="equipmentNO" class="inputtran" onchange="checkNames('equipmentNO','${equipmentVO.equipmentNO}');" value="${equipmentVO.equipmentNO}" /></td>
        </tr>
        <tr>
