...
function equipmentModify(){
  ...
  <form action="${sys_ctx}/equipment/otherEquipmentModify.action" id="addMcuForm" name="addMcuForm" method="post">
  <input type="hidden" name="equipmentVO.equipmentID" id="equipmentID" class="" value="${equipmentVO.equipmentID}"  />
   <div id="basicform" class="contentwrapper"> 
  <div class="contenttitle2">
        <h5 class="fwb fl10">其他设备修改</h5>
      </div>
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
                    ...
                    <tr>
                      ...
                      <td class="tableadd_data" >
                      	<input type="text" maxlength="25" class="inputtran" name="equipmentVO.ip" id="ip" value="${equipmentVO.ip}"/>
                      </td>
                      <td class="tableaddtitle"><span>*</span>MAC</td>
                      <td class="tableadd_data">
                      	<input type="text" maxlength="25" name="equipmentVO.mac" id="mac" class="inputtran" value="${equipmentVO.mac }" />
                      </td>
                    </tr>
                    <tr>
                      <td class="tableaddtitle"><span>*</span>端口号</td>
                      <td class="tableadd_data" >
                      <input id="port" maxlength="25" name="equipmentVO.port"  type="text" class="inputtran" value="${equipmentVO.port }"/>
                      </td>
                    ...
                    <tbody>
                      <tr>
                        <td>
                           ...
                           <input type="button" class="submit1 radius2" value="确 定" name="button" id="button" onclick="equipmentModify();"/>
