...
<script type="text/javascript">	
     ...
     */
			...
			*/
			...
			function exportEquipment(){
				document.getElementById('pageform').action="${sys_ctx}/equipment/exportUselessEquipment.action";
				document.getElementById('pageform').submit();
				document.getElementById('pageform').action="${sys_ctx}/equipment/queryUselessEquipment.action";
			}
 ...
 <form action="${sys_ctx}/equipment/queryUselessEquipment.action" id="pageform" name="pageform" method="post">
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="query_table">
        ...
        <tbody>
          <c:forEach items="${equipmentVOList}" var="equipmentVO" 	varStatus="state">
                ...
                <td><zzst:lable value="${equipmentVO.status}" type="equipmentStatus"></zzst:lable></td>
          	    <td class="alc">
