...
<script type="text/javascript" >
  <!--
	...
	function dropPrev(treeId, nodes, targetNode) {
		...
		var temId = document.getElementById("templateId").value;
		...
		McuDwrMethod.modifyPollTerminal(temId,temName,terArr,locArr,callback);
...
<input type="hidden" value="${pollTemplateVO.pollTemplateID }" id="templateId"/>
	<div class="contenttitle2">
        <h5 class="fwb fl10">
            <table cellpadding="0" cellspacing="0" border="0">
            	<tr>
                    <td><span>*</span>模板名称 <input type="text" id="templateName" value="${pollTemplateVO.pollTemplateName }"/></td>
	...
	<table cellpadding="0" cellspacing="0" border="0" class="buttoncontainer" id="table">
        ...
        <tbody>
            <tr>
                <td>
                    <input type="submit" class="submit1 radius2" value="确 定" onclick="modifyTemplate()"/>
