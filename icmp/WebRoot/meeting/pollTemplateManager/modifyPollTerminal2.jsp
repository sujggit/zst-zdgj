  ...
  <head>
	...
	<script type="text/javascript">
		...
		function modifyTer(){
			...
			var temID = document.getElementById("pollTemplateID").value
			...
			McuDwrMethod.modifyPollTerminal( temID , temName,terArr,callback);
		}
  ...
  <div class="min-widthdiv" style="height: 98%">
	<div id="basicform" class="contentwrapper" style="padding: 3px 3px;">
	 <div class="contenttitle2">
	 	<h5 class="fwb fl10">
			<span style="color: red;">*</span>轮询模板名称 <input name="pollTemplateVO.pollTemplateName" id="pollTemplateName" value="${pollTemplateVO.pollTemplateName }"/>
			<input type="hidden" value="${pollTemplateVO.pollTemplateID}" id="pollTemplateID"/>
		</h5>
   ...
   <ul id="terList">
   	<c:forEach items="${pollTerList}" var="ter" varStatus="k">
   	<li id="ter${k.count }" style="cursor:pointer" >
   	${ter.equipmentVO.equipmentNO}
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="buttoncontainer" id="table">
            ...
            <tbody>
              <tr>
                <td><input type="button" class="submit1 radius2" value="确定" onclick="modifyTer()"/>
               </td>
              </tr>
            </tbody>
  </table>
