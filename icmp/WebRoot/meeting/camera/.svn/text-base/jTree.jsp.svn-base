	...
	<script language="JavaScript">
		...
		function onClickName(event, treeId, treeNode){
		   ...
		   if(!treeNode.isParent){
		   	var meetingDetailID = parent.document.getElementById("filterSelectId").value;
		 	  DwrMethod.videoMonitoring(groupid,meetingDetailID,function(back){
		 	  	parent.document.getElementById("kstMeetNumber").value = back;
		 	  	alert("back::"+back);
		 	  	//alert(parent.document.getElementById("kstMeetNumber").value);
		 	  });
		   }
		};
