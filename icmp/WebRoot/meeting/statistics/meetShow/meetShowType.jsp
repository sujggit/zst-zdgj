...
<body style='OVERFLOW:AUTO;OVERFLOW-X:HIDDEN' >
 ...
 <div id="basicform" class="contentwrapper">
   <form action="${sys_ctx}/vmeeting/viewTypeTotal.action" id="pageform" name="pageform" method="post"> 
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="query_table2">
        <thead>
          <tr>
            ...
            <th width="10%" class="head1">会议类型</th>
            <th width="10%" class="head1">开会次数</th>
           <th width="15%" class="head1">开会时长</th>
       ...
       <script type="text/javascript">
        var depcs="<chart caption='各会议类型开会次数统计（次数）' xAxisName='会议类型' yAxisName='次数' showValues='0' decimals='0' formatNumberScale='0' palette='4'  baseFontSize='12'>";
         var depcs2="<chart caption='各会议类型开会时长统计（小时）' xAxisName='会议类型' yAxisName='小时' showValues='0' decimals='0' formatNumberScale='0' palette='4'  baseFontSize='12'>";
         var depcs_pie="<chart caption='各会议类型开会次数统计（次数）' palette='2' animation='1' formatNumberScale='0' pieSliceDepth='30' startingAngle='125' baseFontSize='12'>";
        var depcs_pie2="<chart caption='各会议类型开会时长统计（小时）' palette='2' animation='1' formatNumberScale='0' pieSliceDepth='30' startingAngle='125' baseFontSize='12'>";
        </script>
