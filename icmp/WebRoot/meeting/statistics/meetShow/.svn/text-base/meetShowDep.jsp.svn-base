...
<body style='OVERFLOW:AUTO;OVERFLOW-X:HIDDEN' >
 <div id="basicform" class="contentwrapper">
   <form action="${sys_ctx}/vmeeting/viewDeptTotal.action" id="pageform" name="pageform" method="post"> 
      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
        <tr>
          ...
          年
           ...
           <select name="findvm.viewMeetingYear"  onchange="modeSelect();">
             <c:forEach items="${yearList}" var="vml" varStatus="state">
			<option value="${vml }">${vml }年</option>
			</c:forEach>
		</select>
           </td>
                  <td class="tableaddtitle">
          月
           ...
           <td class="tableadd_data">
           <select name="findvm.viewMeetingMonth" onchange="modeSelect();">
           <option value="0" selected="selected">选择月份</option>
			<option value="1">1月份</option><option value="2">2月份</option><option value="3">3月份</option><option value="4">4月份</option><option value="5">5月份</option><option value="6">6月份</option><option value="7">7月份</option><option value="8">8月份</option><option value="9">9月份</option><option value="10">10月份</option>
			<option value="11">11月份</option><option value="12">12月份</option>
		</select>
           </td>
          <td class="tableaddtitle" rowspan="3">
        ...
        <tr>
          ...
          <td  class="tableadd_data" colspan="3">
            <input type="hidden" name="findvm.viewDeptPid" id="deptID" value="${findvm.viewDeptPid }" />
            <input name="" value="${deptName }" class="inputtran" id="deptName" onclick="selectDepartments(this);" readonly="readonly" />
          </td>
		</tr>           
      </table>
       </form>
    ...
    <div id="contentwrapper" class="contentwrapper">
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="query_table2">
       ...
       <script type="text/javascript">
        var depcs="<chart caption='部门开会次数统计（次数）' xAxisName='部门' yAxisName='次数' showValues='0' decimals='0' formatNumberScale='0' palette='4' baseFontSize='12'>";
        var depcs2="<chart caption='部门开会时长统计（小时）' xAxisName='部门' yAxisName='小时' showValues='0' decimals='0' formatNumberScale='0' palette='4'  baseFontSize='12'>";
        var depcs_pie="<chart caption='部门开会次数统计（次数）' palette='2' animation='1' formatNumberScale='0' pieSliceDepth='30' startingAngle='125' baseFontSize='12'>";
        var depcs_pie2="<chart caption='部门开会时长统计（小时）' palette='2' animation='1' formatNumberScale='0' pieSliceDepth='30' startingAngle='125' baseFontSize='12'>";
