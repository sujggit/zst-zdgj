...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type='text/javascript'
			src='${swh_ctx }/dwr/interface/StatisticsAction.js'></script>
		<script type="text/javascript"
			src="${sys_ctx }/js/fusionChat/FusionCharts.js"></script>
		...
		<script type="text/javascript">
		 ...
		 function meetingInfoList(tempid){
	      ...
	      var addstr=" and view_meeting_type='"+tempid+"'";
					...
					<tbody>
						...
						<c:forEach items="${vlist}" var="vml" varStatus="state">
							...
							<tr>
								...
								<td>
									<c:out value="${vml.viewMeetingMonth}" />
									次
								</td>
								<td>
									<fmt:formatNumber value="${vml.viewTimeLong}" pattern="#.##" />
									小时
								</td>
								<td>
			...
			<div class="contenttitle2">
				<h5 class="fwb fl10">
					...
					<select id="modeChange" onchange="modeSelect();">
						<option value="tableShow">
							列表模式
						</option>
						<option value="chartdivNumDIV">
							柱状图模式
						</option>
						<option value="chartdivNumDIVPie">
							饼图模式
						</option>
					</select>
				</h5>
