...
idSet.add(e.getEquipmentID());
 ...
 %>
<chart caption="" palette="2" animation="1" formatNumberScale="0" numberPrefix="" labeldisplay="ROTATE" slantLabels="1" seriesNameInToolTip="0" sNumberSuffix=" pcs." showValues="0" plotSpacePercent="0" labelDisplay="STAGGER">
<%
...
for(int i=0;i<list.size();i++){
EquipmentMaintainVO e=((EquipmentMaintainVO)(list.get(i)));
count+=e.getMaintainCost();
}

 %>
<set label="<%=ev.getEquipmentName() %>" value="<%=count %>" />
