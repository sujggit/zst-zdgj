  ...
  <body style='OVERFLOW:AUTO;OVERFLOW-X:HIDDEN'>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd" style="table-layout: fixed">
         <tr>
           ...
           <td width="15%" class="tableaddtitle">主会议室</td>
           <td width="35%" class="tableadd_data">
           ...
           <tr>
            ...
            <tr <c:if test="${sms!=true and email != true and billboard != true and meetingservice != true}">style="display:none"</c:if>>
                   ...
                   <zzst:option type="meetingServiceType" value="${meetingDetailVO.grade}"/>
                   </select>
                   </td>
                   </tr>
            <%
           ...
           <tr>
               ...
               <%-- <td class="tableadd_data">${meetingDetailVO.fullName}</td> --%>
               <td class="tableadd_data">${meetingDetailVO.info1}</td>
               <td class="tableaddtitle">会议模式</td>
	           <td class="tableadd_data">  
             	<zzst:lable type="linkMeetingModel" value="${meetingDetailVO.confProfileID}"/>
        	   </td>
           </tr>  
           
            <tr>
             <td class="tableaddtitle" >参会会场</td>
             <td colspan="3" class="tableadd_data" ><c:out  value="${meetingDetailVO.meetingRoomNamesTrim}"></c:out></td>
           </tr>
           <%-- <tr>
             <td class="tableaddtitle">参会人员</td>
             <td colspan="3" class="tableadd_data" ><c:out value="${meetingDetailVO.meetingUserNamesTrim}"/></td>
           </tr> --%>
           <tr>
          ...
          <tr style="display: none;">
           ...
           <tr>
             ...
             <td colspan="3" class="tableadd_data" ><textarea name="datepicker" rows="5" class="areatran" id="datepicker" readonly="readonly"><c:out value="${meetingDetailVO.meetingDescription }"/></textarea></td>
           </tr>
