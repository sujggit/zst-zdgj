                  ...
                  DictionaryVO dvs=(DictionaryVO)dvList.get(i);
                   ...
                   <tr>
                   	...
                   	<td class="tableadd_data" colspan="3"  >
						<input  name="meetingDetailVO.info1" value="${meetingDetailVO.info1 }" type="text" class="areatran" readonly="readonly"/>
					</td>
                   </tr>
                   <tr>
                     ...
                     <td colspan="3" class="tableadd_data" >
			          ...
			          function getReturnVenueMethod(conferenceArray){
			              ...
			              document.getElementById("meetingRoomNameIDs").value=conferenceID;
                          	...
                          	<input type="hidden" id="canhuizhe" name="meetingDetailVO.info3" value="${meetingDetailVO.info3}"/>
                          	  <script type="text/javascript">
                          ...
                          <tr>
                              <td class="tableaddtitle" style="vertical-align:top;">主持人</td>
                          	  <td colspan="3" class="tableadd_data" id="zcr"></td>
                          </tr>
                          <tr>
                              <td class="tableaddtitle" style="vertical-align:top;">主席台</td>
                          	  <td colspan="3" class="tableadd_data" id="zxt"></td>
                          </tr>
                          <tr>
                              <td class="tableaddtitle" style="vertical-align:top;">参会人员</td>
                          	  <td colspan="3" class="tableadd_data" id="chz"></td>
                          </tr>
                                        <%-- <tr>
           ...
           <tbody>
             <tr>
               <td>
               	...
               	<input type="button" name="button2" id="button2" value="返 回"  class="reset1 radius2" onclick="backHistory();"/>
               </td>
             </tr>
           </tbody>
         </table>
