...
<form action="${sys_ctx}/config/addCenterControlInfo.action" id="centerControlAddForm" name="centerControlAddForm" method="post">
<input type="hidden" name="" id="centerControlVO.id" value="${centerControlVO.id}"/>
    <div id="basicform" class="contentwrapper">
        <div class="contenttitle2">
          <h5 class="fwb fl10">中控配置复制</h5>
        </div>
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
          <tr>
            <td class="tableaddtitle"><span>*</span>设备名称</td>
            <td class="tableadd_data"><input name="centerControlVO.equipmentName" id="equipmentName" class="inputtran" />  </td>
          </tr>
          <tr>
          ...
          <tr>
			...
			<td class="tableadd_data">
				<select name="centerControlVO.equipmentType" id="equipmentType"
					...
					<zzst:option type="ccequipmentType" value="" required="true" />
				</select>
          ...
          <tr>
            ...
            <td class="tableadd_data"><input name="centerControlVO.ccNO" id="ccNO" class="inputtran" value=""/></td>
          </tr>
          <tr>
