...
<%--	 		insertOption(selectedMainMeetingRoomID, selectedNode.innerHTML, selectedNode.id);--%>
    ...
    function selected(id,classname){
    		//var nodes = document.getElementsByName("nodeName");
 			//for(var i=0; i<nodes.length; i++){
 	 			
 				//nodes[i].className = selectdeid;
 			//}
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="leftviewdataOff1">
        <tr>
          <td width="48%" class="" style="padding-bottom: 5px;"><h5 class="fwb fl10" style="margin-top: 6px;margin-bottom: 10px;">
          	请选择会场&nbsp;&nbsp;共<span style="font-weight:bold;text-align:center;color:red;"  id="allVenueSpan">0</span>个会场</h5><h5 class="fwb fl10" style="margin-left:40px;height:5px;margin-top: 6px;margin-bottom: 10px;" >搜索:&nbsp;&nbsp;&nbsp;<input id="searchMeeingRoom"  type="text" class="glass" value="" onkeyup="serachRoom(this)"/></h5>
          	  </td>
          <td></td>
          <td width="48%" class="" style="padding-bottom: 5px;">
          <h5 class="fwb fl10" style="margin-top: 6px;margin-bottom: 10px;">已选择<span style="color:#F00;" id="roomCount">0</span>个会场</h5><h5 class="fwb fl10" style="margin-left:40px;height:5px;margin-top: 6px;margin-bottom: 10px;" >搜索:&nbsp;&nbsp;&nbsp;<input id="searchMeeingRoom"  type="text" class="glass" value="" onkeyup="serachRoom1(this)" /></h5>
            
        </tr>
        <tr>
          <td><div style="border:#ddd 1px solid; width:100%; height:250px; margin:0 auto; overflow:auto;background-color:white">
		...
		var venueNum = 0;
				...
				for( var i=0; i<allA.length; i++ ){
					...
					if( strIndex != -1){//匹配到节点
						...
						for( var j=0; j<allNodes.length; j++){
							//alert("会议室："+allA[i].id+"i:"+i+"====节点："+allNodes[j].id);
          ...
          <td><div style="border:#ddd 1px solid; width:100%; height:250px; margin:0 auto;">
        ...
        <tr >
		  ...
		  <td><span style="color: red">*</span>主会场&nbsp;
          	 <span style="overflow-x:hidden">
          	 	<select name="meetingDetailVO.meetingRoomID" id="selectedMainMeetingRoomID" class="" onchange="changeMainRoomName('selectedMainMeetingRoomID', 'mainMeetingRoomName');">
	              <option value="-1">请选择...</option>
	           </select>
          	 </span>
          </td>	
          <td style="vertical-align:middle;">&nbsp;</td>
          <td height="39" id="mySelect_02"><span style="color: red">*</span>会议模式&nbsp;
