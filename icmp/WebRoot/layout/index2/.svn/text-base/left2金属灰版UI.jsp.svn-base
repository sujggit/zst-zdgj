...
.lefttitle1{ background:url(images/topbg.png); color:#3D3D3D; height: 43;font-family:"微软雅黑","黑体";font-size:18px;font-weight:bold; line-height:34px;text-shadow:1px 1px 1px #999999;}
.header{ padding: 10px;border-bottom:1px solid #7a7b79;min-height:20px;display:block; height:44px; weight:220px;font-family:"微软雅黑","黑体";font-size:16px;
		background:url(images/left.jpg) repeat-x ;cursor: pointer}
.header:hover{background:url(images/left_2.jpg) repeat-x;cursor: pointer}
.label { padding-left: 24px; background: no-repeat;float:left}
...
tr td ul li { background-color: #ececec; padding: 12px; border-bottom: 1px solid #dcdcdc; border-top: 1px solid #fff; color: #727272; text-shadow: 0px 1px 0px rgba(255, 255, 255, 0.8);cursor:pointer;font-family:"微软雅黑","黑体";font-size:14px;}
tr td ul li:hover{ background: #e7e7e7; /* Old browsers */	cursor: pointer;	}
tr td ul li:active{ background: #f1f1f1; /* Old browsers */	cursor: pointer;	}
</style>
...
<table width="180px" border="0" cellspacing="0" cellpadding="0" >
  <tr>
	<td class="lefttitle1 ac " id="muteName">功能菜单</td>
  </tr>
</table>
