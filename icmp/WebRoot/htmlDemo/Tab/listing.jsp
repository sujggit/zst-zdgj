...
<div class="contentwrapper">
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableadd">
		<tr>
			...
			<td class="tableaddtitle">选择会议室</td>
			<td class="tableadd_data"><input id="datepicker2" type="text" class="most" /></td>
			<td class="tableaddtitle"><input type="reset" class="stdbtn mlr10" value="查 询" /></td>
		</tr>
	</table>
	...
	<div id="basicform" class="contentwrapper">
		<div class="contenttitle2">
			...
			<h5 class="fwb fr10"><a href="listing_add.jsp">增加</a> <a href="#">批量删除</a></h5>
		</div>
