package com.zzst.mcu.service.impl.rmx2000.impl;
...
import com.zzst.mcu.service.impl.MCUHelpUtil;
 ...
 *@author ryan
 */
public class MCU2000ServiceImplHelp {
	...
	public static	MeetingInfoVO	assayCreatMeetingReStr_2000(MeetingInfoVO meetingInfoVO,String reStr){
		...
		if(!IDEnum.succeed.equalsIgnoreCase(meetingInfoVO.getId()))	return meetingInfoVO;
