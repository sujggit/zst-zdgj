 ...
 * @see ClientMgr
 **/
public interface _ClientOperations extends vmxICE._ResourceOperations
{
    /**
     * 设置客户端名称.
     * 
     ...
     * 
     **/
    int setClientName(String name, Ice.Current __current);
     ...
     * 
     **/
    int getClientName(Ice.StringHolder name, Ice.Current __current);
     ...
     * 
     **/
    int getConnectState(ClientConnectStateHolder state, Ice.Current __current);
     ...
     * 
     **/
    int setConnectMode(ClientConnectMode mode, Ice.Current __current);
     ...
     * 
     **/
    int getConnectMode(ClientConnectModeHolder mode, Ice.Current __current);
     ...
     * 
     **/
    int connect(Ice.Current __current);
     ...
     * 
     **/
    int disconnect(Ice.Current __current);
     ...
     * 
     **/
    int updateMediaCapability(Ice.Current __current);
     ...
     * 
     **/
    int execCommand(Command cmd, Ice.Current __current);
     ...
     * 
     **/
    int enumSupportCommand(CommandListHolder list, Ice.Current __current);
     ...
     * 
     **/
    int close(Ice.Current __current);
}
