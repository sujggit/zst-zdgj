...
// <auto-generated>
//
// Generated from file `_ClientMgrDelM.java'
//
...
public final class _ClientMgrDelM extends Ice._ObjectDelM implements _ClientMgrDel
{
    public int
    ...
    freeClient(String ID, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("freeClient", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            try
            {
    ...
    freeClientList(String[] list, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("freeClientList", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            try
            {
    ...
    getClient(int index, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getClient", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            try
            {
    ...
    getClientCount(Ice.IntHolder count, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getClientCount", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
    ...
    getClientID(int index, Ice.StringHolder ID, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getClientID", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            try
            {
    ...
    getIdleClient(Ice.StringHolder ID, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getIdleClient", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
    ...
    getIdleClientList(int num, ClientIDListHolder list, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getIdleClientList", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            try
            {
