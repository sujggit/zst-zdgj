...
// <auto-generated>
//
// Generated from file `Callback_Conference_getClientList.java'
//
...
public abstract class Callback_Conference_getClientList extends Ice.TwowayCallback
{
    ...
    public final void __completed(Ice.AsyncResult __result)
    {
        ...
        try
        {
            __ret = __proxy.end_getClientList(list, __result);
        }
