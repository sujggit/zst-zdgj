...
// <auto-generated>
//
// Generated from file `_ClientMgrDisp.java'
//
 ...
 * 
 **/
public abstract class _ClientMgrDisp extends Ice.ObjectImpl implements ClientMgr
{
    protected void
    ...
    {
        return freeObjectList(list, null);
    }
    ...
    {
        return getAllObjectList(list, null);
    }
    ...
    {
        return getIdleObjectList(num, list, null);
    }
    ...
    {
        return getObjectByIndex(index, ID, null);
    }
    ...
    {
        return getChildrenID(list, null);
    }
    ...
    {
        return freeClientList(list, null);
    }
     ...
     * 
     **/
    public final ClientPrx
    getClient(int index)
    {
        return getClient(index, null);
    }
    ...
    {
        return getClientCount(count, null);
    }
    ...
    {
        return getClientID(index, ID, null);
    }
    ...
    {
        return getIdleClientList(num, list, null);
    }

    public static Ice.DispatchStatus
    ___getClient(ClientMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        ClientPrx __ret = __obj.getClient(index, __current);
        ClientPrxHelper.__write(__os, __ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___getClientID(ClientMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getClientID(index, ID, __current);
    ...
    public static Ice.DispatchStatus
    ___getClientCount(ClientMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        Ice.IntHolder count = new Ice.IntHolder();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getClientCount(count, __current);
    ...
    public static Ice.DispatchStatus
    ___getClientType(ClientMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus
    ___getIdleClient(ClientMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        Ice.StringHolder ID = new Ice.StringHolder();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getIdleClient(ID, __current);
        __os.writeString(ID.value);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    public static Ice.DispatchStatus
    ___getIdleClientList(ClientMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getIdleClientList(num, list, __current);
    ...
    public static Ice.DispatchStatus
    ___freeClient(ClientMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        __is.endReadEncaps();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.freeClient(ID, __current);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___freeClientList(ClientMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        __is.endReadEncaps();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.freeClientList(list, __current);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 3:
            {
                return ___freeClient(this, in, __current);
            }
            case 4:
            {
                return ___freeClientList(this, in, __current);
            }
            case 5:
            {
                return vmxICE._ObjectMgrDisp.___freeObject(this, in, __current);
            }
            case 6:
            {
                return vmxICE._ObjectMgrDisp.___freeObjectList(this, in, __current);
            }
            case 7:
            {
                return vmxICE._ObjectMgrDisp.___getAllObjectList(this, in, __current);
            }
            case 8:
            {
                return vmxICE._VMXContainerDisp.___getChildrenID(this, in, __current);
            }
            case 9:
            {
                return ___getClient(this, in, __current);
            }
            case 10:
            {
                return ___getClientCount(this, in, __current);
            }
            case 11:
            {
                return ___getClientID(this, in, __current);
            }
            case 12:
            {
            ...
            case 14:
            {
                return ___getIdleClient(this, in, __current);
            }
            case 15:
            {
                return ___getIdleClientList(this, in, __current);
            }
            case 16:
            {
                return vmxICE._ObjectMgrDisp.___getIdleObject(this, in, __current);
            }
            case 17:
            {
                return vmxICE._ObjectMgrDisp.___getIdleObjectList(this, in, __current);
            }
            case 18:
            {
            ...
            case 19:
            {
                return vmxICE._ObjectMgrDisp.___getObjectByIndex(this, in, __current);
            }
            case 20:
            {
                return vmxICE._ObjectMgrDisp.___getObjectCount(this, in, __current);
            }
            case 21:
            {
            ...
            case 31:
            {
                return vmxICE._ObjectMgrDisp.___isObjectIdle(this, in, __current);
            }
            case 32:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type vmxMP::ClientMgr was not generated with stream support";
        throw ex;
    }
