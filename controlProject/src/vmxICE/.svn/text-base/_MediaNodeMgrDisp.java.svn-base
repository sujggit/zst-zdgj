...
// <auto-generated>
//
// Generated from file `_MediaNodeMgrDisp.java'
//
 ...
 **/
public abstract class _MediaNodeMgrDisp extends Ice.ObjectImpl implements MediaNodeMgr
{
    protected void
    ...
    {
        recvMedia(nodeIndex, padIndex, seq, null);
    }
    ...
    {
        recvMediaEx(nodeIndexList, padIndexList, seq, null);
    }
    ...
    ___recvMedia(MediaNodeMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        int nodeIndex;
        nodeIndex = __is.readInt();
        int padIndex;
        padIndex = __is.readInt();
        byte[] seq;
        seq = ByteSeqHelper.read(__is);
        __is.endReadEncaps();
        __obj.recvMedia(nodeIndex, padIndex, seq, __current);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___recvMediaEx(MediaNodeMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        int[] nodeIndexList;
        nodeIndexList = IntSeqHelper.read(__is);
        int[] padIndexList;
        padIndexList = IntSeqHelper.read(__is);
        byte[] seq;
        seq = ByteSeqHelper.read(__is);
        __is.endReadEncaps();
        __obj.recvMediaEx(nodeIndexList, padIndexList, seq, __current);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 3:
            {
                return _ObjectMgrDisp.___freeObject(this, in, __current);
            }
            case 4:
            {
                return _ObjectMgrDisp.___freeObjectList(this, in, __current);
            }
            case 5:
            {
                return _ObjectMgrDisp.___getAllObjectList(this, in, __current);
            }
            case 6:
            {
            ...
            case 8:
            {
                return _ObjectMgrDisp.___getIdleObject(this, in, __current);
            }
            case 9:
            {
                return _ObjectMgrDisp.___getIdleObjectList(this, in, __current);
            }
            case 10:
            {
            ...
            case 11:
            {
                return _ObjectMgrDisp.___getObjectByIndex(this, in, __current);
            }
            case 12:
            {
                return _ObjectMgrDisp.___getObjectCount(this, in, __current);
            }
            case 13:
            {
            ...
            case 23:
            {
                return _ObjectMgrDisp.___isObjectIdle(this, in, __current);
            }
            case 24:
            {
            ...
            case 25:
            {
                return ___recvMediaEx(this, in, __current);
            }
            case 26:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type vmxICE::MediaNodeMgr was not generated with stream support";
        throw ex;
    }
