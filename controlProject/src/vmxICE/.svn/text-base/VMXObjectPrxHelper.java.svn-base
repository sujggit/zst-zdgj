...
// <auto-generated>
//
// Generated from file `VMXObjectPrxHelper.java'
//
 ...
 **/
public final class VMXObjectPrxHelper extends Ice.ObjectPrxHelperBase implements VMXObjectPrx
{
    /**
    ...
    enumMessageList(MsgDescListHolder msgList, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _VMXObjectDel __del = (_VMXObjectDel)__delBase;
    ...
    public static VMXObjectPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        VMXObjectPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (VMXObjectPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    VMXObjectPrxHelper __h = new VMXObjectPrxHelper();
    ...
    __createDelegateM()
    {
        return new _VMXObjectDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _VMXObjectDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, VMXObjectPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            VMXObjectPrxHelper result = new VMXObjectPrxHelper();
