...
// <auto-generated>
//
// Generated from file `_VMXManagerDelM.java'
//
...
public final class _VMXManagerDelM extends Ice._ObjectDelM implements _VMXManagerDel
{
    public ObjectMgrInfo[]
    getObjectMgrList(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getObjectMgrList", Ice.OperationMode.Normal, __ctx);
        try
        {
    ...
    registerMgr(String ID, String name, int objectType, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("registerMgr", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
