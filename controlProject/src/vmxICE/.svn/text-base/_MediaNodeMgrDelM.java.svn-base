...
// <auto-generated>
//
// Generated from file `_MediaNodeMgrDelM.java'
//
...
public final class _MediaNodeMgrDelM extends Ice._ObjectDelM implements _MediaNodeMgrDel
{
    public void
    ...
    recvMediaEx(int[] nodeIndexList, int[] padIndexList, byte[] seq, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("recvMediaEx", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
