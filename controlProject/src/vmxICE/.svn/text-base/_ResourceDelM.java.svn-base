...
// <auto-generated>
//
// Generated from file `_ResourceDelM.java'
//
...
public final class _ResourceDelM extends Ice._ObjectDelM implements _ResourceDel
{
    public int
    enumInputNode(MediaNodeListHolder list, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            ...
            try
            {
                ...
                list.value = MediaNodeListHelper.read(__is);
                int __ret;
                __ret = __is.readInt();
                __is.endReadEncaps();
                return __ret;
    ...
    public int
    enumOutputNode(MediaNodeListHolder list, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
