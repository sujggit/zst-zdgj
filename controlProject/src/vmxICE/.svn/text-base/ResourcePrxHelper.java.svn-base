...
// <auto-generated>
//
// Generated from file `ResourcePrxHelper.java'
//
...
public final class ResourcePrxHelper extends Ice.ObjectPrxHelperBase implements ResourcePrx
{
    ...
    private int
    enumInputNode(MediaNodeListHolder list, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ResourceDel __del = (_ResourceDel)__delBase;
    ...
    private int
    enumOutputNode(MediaNodeListHolder list, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
