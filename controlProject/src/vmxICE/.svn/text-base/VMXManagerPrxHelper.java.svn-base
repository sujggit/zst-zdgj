...
// <auto-generated>
//
// Generated from file `VMXManagerPrxHelper.java'
//
...
public final class VMXManagerPrxHelper extends Ice.ObjectPrxHelperBase implements VMXManagerPrx
{
    /**
     * 获取所有对象池的ID列表.
     * 
    ...
    getObjectMgrList()
    {
        return getObjectMgrList(null, false);
    }
    ...
    {
        return getObjectMgrList(__ctx, true);
    }

    private ObjectMgrInfo[]
    getObjectMgrList(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getObjectMgrList");
                __delBase = __getDelegate(false);
                _VMXManagerDel __del = (_VMXManagerDel)__delBase;
                return __del.getObjectMgrList(__ctx);
            }
    ...
    private static final String __getObjectMgrList_name = "getObjectMgrList";
    ...
    {
        return begin_getObjectMgrList(null, false, null);
    }
    ...
    {
        return begin_getObjectMgrList(__ctx, true, null);
    }
    ...
    {
        return begin_getObjectMgrList(null, false, __cb);
    }
    ...
    {
        return begin_getObjectMgrList(__ctx, true, __cb);
    }
    ...
    private Ice.AsyncResult begin_getObjectMgrList(java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        __checkAsyncTwowayOnly(__getObjectMgrList_name);
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __getObjectMgrList_name, __cb);
        try
        {
            __result.__prepare(__getObjectMgrList_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
     ...
     * @param __ret (return value) 返回所有的对象池的ID的列表.
     * 
     **/
    public ObjectMgrInfo[] end_getObjectMgrList(Ice.AsyncResult __result)
    {
        Ice.AsyncResult.__check(__result, this, __getObjectMgrList_name);
        if(!__result.__wait())
        {
            try
            {
        ...
        __ret = ObjectMgrInfoListHelper.read(__is);
        __is.endReadEncaps();
        return __ret;
    }
    ...
    {
        return registerMgr(ID, name, objectType, null, false);
    }
     ...
     **/
    public int
    registerMgr(String ID, String name, int objectType, java.util.Map<String, String> __ctx)
    {
        return registerMgr(ID, name, objectType, __ctx, true);
    }

    private int
    registerMgr(String ID, String name, int objectType, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("registerMgr");
                __delBase = __getDelegate(false);
                _VMXManagerDel __del = (_VMXManagerDel)__delBase;
                return __del.registerMgr(ID, name, objectType, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex);
    ...
    private static final String __registerMgr_name = "registerMgr";
    ...
    {
        return begin_registerMgr(ID, name, objectType, null, false, null);
    }
    ...
    {
        return begin_registerMgr(ID, name, objectType, __ctx, true, null);
    }
    ...
    {
        return begin_registerMgr(ID, name, objectType, null, false, __cb);
    }
    ...
    {
        return begin_registerMgr(ID, name, objectType, __ctx, true, __cb);
    }
    ...
    private Ice.AsyncResult begin_registerMgr(String ID, String name, int objectType, java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        __checkAsyncTwowayOnly(__registerMgr_name);
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __registerMgr_name, __cb);
        try
        {
            __result.__prepare(__registerMgr_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
            IceInternal.BasicStream __os = __result.__os();
            __os.writeString(ID);
    ...
    {
        Ice.AsyncResult.__check(__result, this, __registerMgr_name);
        if(!__result.__wait())
        {
            try
            {
    ...
    public static VMXManagerPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        VMXManagerPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (VMXManagerPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    VMXManagerPrxHelper __h = new VMXManagerPrxHelper();
    ...
    __createDelegateM()
    {
        return new _VMXManagerDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _VMXManagerDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, VMXManagerPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            VMXManagerPrxHelper result = new VMXManagerPrxHelper();
