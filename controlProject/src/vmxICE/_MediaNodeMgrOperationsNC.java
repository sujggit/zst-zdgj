...
// <auto-generated>
//
// Generated from file `_MediaNodeMgrOperationsNC.java'
//
 ...
 **/
public interface _MediaNodeMgrOperationsNC extends _ObjectMgrOperationsNC
{
    /**
     * 节点的接收数据函数，
     * 
     ...
     * 
     **/
    void recvMedia(int nodeIndex, int padIndex, byte[] seq);
     ...
     * 
     **/
    void recvMediaEx(int[] nodeIndexList, int[] padIndexList, byte[] seq);
}
