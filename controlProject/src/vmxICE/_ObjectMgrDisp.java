...
// <auto-generated>
//
// Generated from file `_ObjectMgrDisp.java'
//
 ...
 **/
public abstract class _ObjectMgrDisp extends Ice.ObjectImpl implements ObjectMgr
{
    protected void
    ...
    ___getObjectCount(ObjectMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getObjectCount(__current);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___getObjectByIndex(ObjectMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getObjectByIndex(index, ID, __current);
    ...
    public static Ice.DispatchStatus
    ___getIdleObject(ObjectMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        Ice.StringHolder ID = new Ice.StringHolder();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getIdleObject(ID, __current);
        __os.writeString(ID.value);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    public static Ice.DispatchStatus
    ___getIdleObjectList(ObjectMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getIdleObjectList(num, list, __current);
        StringSeqHelper.write(__os, list.value);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___getAllObjectList(ObjectMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        StringSeqHolder list = new StringSeqHolder();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getAllObjectList(list, __current);
        StringSeqHelper.write(__os, list.value);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    public static Ice.DispatchStatus
    ___isObjectIdle(ObjectMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        __is.endReadEncaps();
        IceInternal.BasicStream __os = __inS.os();
        boolean __ret = __obj.isObjectIdle(ID, __current);
        __os.writeBool(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___freeObject(ObjectMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        __is.endReadEncaps();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.freeObject(ID, __current);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___freeObjectList(ObjectMgr __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        String[] list;
        list = StringSeqHelper.read(__is);
        __is.endReadEncaps();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.freeObjectList(list, __current);
        __os.writeInt(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 3:
            {
                return ___freeObject(this, in, __current);
            }
            case 4:
            {
                return ___freeObjectList(this, in, __current);
            }
            case 5:
            {
                return ___getAllObjectList(this, in, __current);
            }
            case 6:
            {
                return _VMXContainerDisp.___getChildrenID(this, in, __current);
            }
            case 7:
            {
            ...
            case 8:
            {
                return ___getIdleObject(this, in, __current);
            }
            case 9:
            {
                return ___getIdleObjectList(this, in, __current);
            }
            case 10:
            {
            ...
            case 11:
            {
                return ___getObjectByIndex(this, in, __current);
            }
            case 12:
            {
                return ___getObjectCount(this, in, __current);
            }
            case 13:
            {
            ...
            case 23:
            {
                return ___isObjectIdle(this, in, __current);
            }
            case 24:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type vmxICE::ObjectMgr was not generated with stream support";
        throw ex;
    }
