...
// <auto-generated>
//
// Generated from file `_VMXContainerDisp.java'
//
 ...
 **/
public abstract class _VMXContainerDisp extends Ice.ObjectImpl implements VMXContainer
{
    protected void
    ...
    ___getChildrenID(VMXContainer __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        StringSeqHolder list = new StringSeqHolder();
        IceInternal.BasicStream __os = __inS.os();
        int __ret = __obj.getChildrenID(list, __current);
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 3:
            {
                return ___getChildrenID(this, in, __current);
            }
            case 4:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type vmxICE::VMXContainer was not generated with stream support";
        throw ex;
    }
